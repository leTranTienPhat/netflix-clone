...
type Props = {
  title: string,
  movies: Movie[]
  //When using Firebase: movies: Movie[] || DocumentData[]
}
...
const Row = ({ title, movies }: Props) => {
  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      <h2 className="w-56 cursor-pointer text-sm font-semibold text-[#e5e5e5] trantision duration-200 hover:text-white md:text-2xl">{title}</h2>
